...
mexHelper(VERBOSE,WIN,OPT,LARGEARRAYDIMS,EXT,'reorth_mex.c','-output','reorth',LAPACK,BLAS,X,Y);
% compile SVT code
...
mexHelper(VERBOSE,WIN,OPT,LARGEARRAYDIMS,EXT,'updateSparse.c',X,Y); % April 2011, removing BLAS
